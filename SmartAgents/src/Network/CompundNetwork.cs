...
namespace SmartAgents
{
    ...
    public class CompoundNetwork : ScriptableObject
    {
        ...
        {
            actorNetwork = new ArtificialNeuralNetwork(inputs, outputs, size, activationFunction, outputActivationFunction, lossFunction, "Actor");
            criticNetwork = new ArtificialNeuralNetwork((inputs + outputs), 1, size, ActivationType.Tanh, ActivationType.Tanh, LossType.MeanSquare, "Critic");
