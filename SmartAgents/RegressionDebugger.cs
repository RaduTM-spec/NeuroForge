...
public class RegressionDebugger : MonoBehaviour
{
    ...
    private void Start()
    {
        net = new NeuralNetwork(1, 1, hiddenUnits, layerNum, activation, ActivationType.Tanh, LossType.MeanSquare, InitializationType.Xavier, InitializationType.Xavier,true, "regressionTest");
        Generate_Data();
