...
namespace NeuroForge
{
    public class HyperParameters : MonoBehaviour
    {
        ...
        [Header("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------")]
        [SerializeField] private BufferSize bufferSize = BufferSize.size2048;    
        [SerializeField] private BatchSize batchSize = BatchSize.size512;
        ...
        private void Awake()
        {
            buffer_size = (int)Math.Pow(2, (int)bufferSize + 9);
            batch_size = (int)Math.Pow(2, (int)batchSize + 7);
